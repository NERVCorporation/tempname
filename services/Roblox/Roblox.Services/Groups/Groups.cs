...
public class GroupsService : ServiceBase, IService
{
    ...
    private static readonly Regex RobloxGroupUrlRegex = new("https:\\/\\/(www\\.)?www.roblox.bar\\/groups\\/[0-9]+\\/[a-zA-Z\\-0-9]+", RegexOptions.IgnoreCase);
    
    // Example URL (www is optional): https://www.roblox.bar/My/Groups.aspx?gid=4
    private static readonly Regex RobloxGroupUrlRegexOld = new("https:\\/\\/(www\\.)?www.roblox.bar\\/my\\/groups\\.aspx\\?gid=[0-9]+", RegexOptions.IgnoreCase);
